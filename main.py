...
# ===== لیست سیاه کلمات (بدون کلمات پزشکی) =====
BLOCKED_WORDS = [
    ...
    # کلمات مرتبط با برند "آخرین خبر" (در صورت وجود، کل خبر رد می‌شود)
    "آخرین خبر", "آخرین‌خبر", "اخرین خبر", "اخرین‌خبر",
    "آخرين خبر", "آخرين‌خبر", "akharinkhabar", "Akharinkhabar",
    "AKHARINKHABAR", "AkharinKhabar", "akharin khabar",
    "آخرین خبر در روبیکا", "آخرین خبر در ایتا", "آخرین خبر در بله",
    "آخرین خبر در سروش", "آخرین خبر در گپ", "سایت آخرین خبر",
    "اپلیکیشن آخرین خبر", "اینستاگرام آخرین خبر", "کافه بازار",
    "گوگل پلی", "آی‌دی @akharinkhabar", "سوء استفاده از نام",
    "لوگوی آخرین خبر", "شبکه‌های اجتماعي", "پلتفرم‌ها",
    "پیام‌رسان‌های داخلی", "rubika.ir", "eitaa.com", "ble.ir",
    "splus.ir", "gap.im", "akharinkhabar.ir", "akhr.ir",
    "t.me/akharinkhabar", "t.me/Akharinkhabar",
    "instagram.com/akharinkhabar", "telegram.me/akharinkhabar",
    "www.akharinkhabar.ir", "https://akharinkhabar.ir",
    "https://rubika.ir/Akharinkhabar", "https://eitaa.com/akharinkhabar",
    "https://ble.ir/akharinkhabar", "https://splus.ir/akharinkhabar",
    "https://gap.im/akharinkhabar",
    "آخرین  خبر", "آخرین‌ خبر", "آخرین‌خبر", "آخرین‌‌خبر",
    "اخرین  خبر", "اخرین‌ خبر",
    "کانال‌های آخرین‌خبر", "کانال های آخرین خبر",
    "آخرین خبر را دنبال کنید", "ما را در شبکه های اجتماعی دنبال کنید",
    "سوئ استفاده از نام", "آی دی @akharinkhabar",
    "برای کپی کلیک کنید", "شماره کارت/شبا",
]
...
async def handler(event):
    try:
        ...
        # فیلترهای دفاعی
        if contains_blocked(text) or has_financial_scam(text) or too_many_links(text, max_links=4):
            print("⛔ تبلیغ / کلاهبرداری")
            return

        # اسپم آخرین خبر: اگر بیش از ۲ بار نام برند ذکر شده باشد، بلاک
...
if __name__ == "__main__":
    if not SESSION_STRING:
        ...
        print("🚀 ربات کامل و ضداسپم احسان روشن شد.")
        with client:
