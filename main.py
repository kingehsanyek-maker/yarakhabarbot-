...
# کانال‌های مبدأ جدید (ایرنا، ایسنا و مشکات)
...
# کلمات ممنوعه اضافی برای منابع جدید
EXTRA_BLOCKED_FOR_SOURCES = [
    ...
    "برای مطالعه بیشتر به سایت",
    "جزئیات در:",
]
BLOCKED_WORDS.extend(EXTRA_BLOCKED_FOR_SOURCES)

TEXTS_TO_REMOVE = [
    # صدا و سیما (دیگر استفاده نمی‌شود اما محض احتیاط)
    "@iribnews",
    "t.me/iribnews", "https://t.me/iribnews",
    "www.iribnews.ir", "https://www.iribnews.ir", "http://www.iribnews.ir",
    "iribnews.ir",
    # ایرنا
    "@IRNA_1313",
    "t.me/irna_1313", "https://t.me/irna_1313",
    "www.irna.ir", "https://www.irna.ir", "http://www.irna.ir",
    "irna.ir",
    # ایسنا
    "@isna94",
    "t.me/isna94", "https://t.me/isna94",
    "www.isna.ir", "https://www.isna.ir", "http://www.isna.ir",
    "isna.ir",
    # مشکات
...
def clean_text(text):
    ...
    text = re.sub(r"\S*\.ir\S*", "", text)  # حذف دامنه‌های .ir
...
if __name__ == "__main__":
    if not SESSION_STRING:
        ...
        print("🚀 ربات حرفه‌ای (ایرنا + ایسنا + مشکات) روشن شد.")
        with client:
